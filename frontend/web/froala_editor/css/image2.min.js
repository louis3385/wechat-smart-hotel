 ...
 */
 ...
 window.alert = function(ar) {
 	console.log(ar);
 	var display2 = document.querySelector('#display2');
 	if (display2) {
 		display2.innerHTML += "</br>" + ar;
 	}
 }
 ...
 ! function(a) {
    ...
    "use strict";
 	a.extend(a.FE.POPUP_TEMPLATES, {
        ...
        imageUploadURL: "http://www.baidu.com",//http://i.froala.com/upload",
        ...
        function d() {
        	...
        	if (c || (c = J()), r(), !c.hasClass("fr-active"))
        		if (b.popups.refresh("image.insert"), b.popups.setContainer("image.insert", b.$tb), a.is(":visible")) {
        			...
        			var z = b.popups.get("image.insert");
        ...
        function i() {
        	...
        	for (c = 0; c < d.length; c++) e.push(d[c].getAttribute("src")), a(d[c]).toggleClass("fr-draggable", b.opts.imageMove);
        		...
        		function m(c) {
        			...
        			if (qa && oa) {
        				...
        				if ((qa.hasClass("fr-hnw") || qa.hasClass("fr-hsw")) && (f = 0 - f), b.opts.imageResizeWithPercent) {
        					...
        					g = ((g + f) / a(h).outerWidth() * 100).toFixed(2), b.opts.imageRoundPercent && (g = Math.round(g)), oa.css("width", g + "%")
        		...
        		function o(a, c) {
        			b.edit.on(), oa && oa.addClass("fr-error"), t(b.language.translate("Something went wrong. Please try again.")), b.events.trigger("image.error", [{
        				code: a,
        				message: Aa[a]
        			}, c])
        		}
        		...
        		function p(a) {
        			...
        			function r(a) {
        				...
        				c && (c.find(".fr-layer.fr-pactive").addClass("fr-active").removeClass("fr-pactive"), c.find(".fr-image-progress-bar-layer").removeClass("fr-active"), c.find(".fr-buttons").hide(), (a || b.$el.find("img.fr-error").length) && (b.events.focus(), b.$el.find("img.fr-error").remove(), b.undo.saveStep(), b.undo.run(), b.undo.dropRedo()))
        			}

        //pop up image status info
        function s(a, c) {
        	var d = b.popups.get("image.insert");
        	if (d) {
        ...
        function x(a, c, d, e, f) {
        	...
        	g.onload = function() {
        		var c, g;
        		alert("local img load remote link");
        		if (e) {
        			...
        			if ("undefined" != typeof d)
        				...
        				alert("else");
        				c = D(a, d, w), i(), b.undo.saveStep(), b.events.trigger("image.inserted", [c, f])
        			}
        		}, g.onerror = function() {
        			o(ta)
        		}, g.src = a
        	...
        	try {
        		if (b.opts.imageUploadToS3)
        			if (201 == c) {
        				...
        				debugger;
        				var h = y(f);
        				h = { link: "https://ss0.baidu.com/73x1bjeh1BF3odCf/it/u=3117273064,622399950&fm=96&s=51AABB571F9A544158D14F6E0300507C" };
                    //上传成功 然后替换url
        ...
        function sendImg(data, callback) {

        	var xhr = b.core.getXHR(b.opts.imageUploadURL, "POST");

        	xhr.onload = function() {
        		a('.loading').removeClass('showing');
        		if (200 == xhr.status) {
        			if ("function" == typeof callback) {
        				callback("http://down.tutu001.com/d/file/20110321/42e531edeb3bf83bfe98ad96cb_560.jpg");
        			}
        		}
        	}
        	xhr.onerror = function() {
        		a('.loading').removeClass('showing');('showing');
        		callback("http://up.2cto.com/2012/0207/20120207012945988.jpg");
        	}
        	xhr.ontimeout=function(){
        		a('.loading').removeClass('showing');
        		callback("http://a.hiphotos.baidu.com/zhidao/wh%3D450%2C600/sign=00ecb208249759ee4a0568cf87cb6f20/c995d143ad4bd1137be6613758afa40f4bfb058f.jpg");
        	}
        	xhr.timeout=5000;
        	/*setTimeout(function(){
        		xhr.abort();
        ...
        //compress image use canvas toDataURL
        //then send base64
        function D(c, d, e) {
        	var f, g = "";

        	alert("arrange preview image");
        	if (d && "undefined" != typeof d)
        		...
        		img.onload = function() {
        			...
        			alert("image orientation " + orientation);
        			if (orientation <= 4) {
        			...
        			var compressSrc = (canvas.toDataURL('image/jpeg', 0.5));
        			alert("compressed image size is " + ~~(compressSrc.length / 1024) + "kb");

        			var formData = new FormData();
        			formData.append('img', compressSrc);
        			formData.append('width', compressWidth);
        			formData.append('height', compressHeight);
        			formData.append('random', +new Date());

        			sendImg(formData, function(imgUrl) {
        				alert("load remote image url");
        				var iu=compressSrc;
        				var i = a('<img class="fr-di' + b.opts.imageDefaultDisplay[0] + ("center" != b.opts.imageDefaultAlign ? " fr-fi" + b.opts.imageDefaultAlign[0] : "") + '" src="' + imgUrl + '"' + g + (h ? ' style="width: ' + h + ';"' : "") + ">");
                    ...
                    //find marmker and replace with image 
                    var j = b.$el.find(".fr-marker");
                    return j.replaceWith(i), b.html.wrap(), b.selection.clear(), i

                    i.attr("src", "http://www.hdb.com/captcha?time=" + (+new Date()) + "&send_type=0");
                });
        ...
        function E(c, d, e) {
        	function f() {
        		...
        		var e = a(this);
        		debugger;
        		e.off("load"), e.addClass("fr-uploading"), e.next().is("br") && e.next().remove(), b.placeholder.refresh(), e.is(oa) || v(e), j(), q(), b.edit.off(), c.onload = function() {

        			alert("compress img");
        			A.call(c, e);
        		}, c.onerror = B, c.upload.onprogress = C, c.send(d)
        	}
        	var g, h = new FileReader;
        	alert("start 2 read file");
                a('.loading').addClass('showing');
        	h.addEventListener("load", function(ar) {
        		alert("load file");
        		...
        		try {
        			...
        			alert("create objectUrl fail");
        		}
        		alert("create ObjectUrl success");
        		oa ? (oa.on("load", f), b.edit.on(), b.undo.saveStep(), oa.data("fr-old-src", oa.attr("src")), oa.attr("src", ar.target.result)) : g = D(ar.target.result, null, f)
        	}, !1), h.readAsDataURL(e)
        }

        //form data and ready2send
        function F(a) {
    ...
    function G(c) {
    	b.events.$on(c, "dragover dragenter", ".fr-image-upload-layer", function() {
    		...
    		if (this.files) {
    			...
    			a('.fr-popup.fr-mobile').removeClass('fr-active');
    ...
    function I() {
    	b.events.$on(b.$el, b._mousedown, "IMG" == b.$el.get(0).tagName ? null : 'img:not([contenteditable="false"])', function(c) {
    		return a(this).parents('[contenteditable="false"]:not(.fr-element)').length ? !0 : (b.selection.clear(), sa = !0, b.browser.msie && (b.events.disableBlur(), b.$el.attr("contenteditable", !1)), b.draggable || c.preventDefault(), void c.stopPropagation())
    	}), b.events.$on(b.$el, b._mouseup, "IMG" == b.$el.get(0).tagName ? null : 'img:not([contenteditable="false"])', function(c) {
    		return a(this).parents('[contenteditable="false"]:not(.fr-element)').length ? !0 : void(sa && (sa = !1, c.stopPropagation(), b.browser.msie && (b.$el.attr("contenteditable", !0), b.events.enableBlur())))
    	}), b.events.on("drop", H), b.events.on("mousedown window.mousedown", ba), b.events.on("window.touchmove", ca), b.events.on("mouseup window.mouseup", aa), b.events.on("commands.mousedown", function(a) {
    ...
    function J(a) {
    	...
    	g >= 0 && (d = " fr-active", h >= 0 && g > h && (d = ""), 
    		i = '<div class="fr-image-upload-layer' + 
    		d + ' fr-layer" id="fr-image-upload-layer-' + b.id +
    		'"><strong>' + "点击选择图片" + "</strong>" + 
    		'<div class="fr-form"><input type="file" id="compressImgInput" accept="image/*" tabIndex="-1"></div></div>');
    	var j = "";
    ...
    function S(a) {
    	...
    	}!oa && b.opts.toolbarInline && (d = e.offset().top - b.helpers.getPX(e.css("margin-top")), e.hasClass("fr-above") && (d += e.outerHeight())), e.find(".fr-layer").removeClass("fr-active"), e.find(".fr-" + a + "-layer").addClass("fr-active"), b.popups.show("image.insert", c, d, oa ? oa.outerHeight() : 0)
    }
    ...
    function V() {
    	var c;
    	b.shared.$image_resizer ? (pa = b.shared.$image_resizer, ra = b.shared.$img_overlay, b.events.on("destroy", function() {
    		pa.removeClass("fr-active").appendTo(a("body"))
    	}, !0)) : (b.shared.$image_resizer = a('<div class="fr-image-resizer"></div>'), pa = b.shared.$image_resizer, b.events.$on(pa, "mousedown", function(a) {
    		a.stopPropagation()
    	}, !0), b.opts.imageResize && (pa.append(k("nw") + k("ne") + k("sw") + k("se")), b.shared.$img_overlay = a('<div class="fr-image-overlay"></div>'), ra = b.shared.$img_overlay, c = pa.get(0).ownerDocument, a(c).find("body").append(ra))), b.events.on("shared.destroy", function() {
    		pa.html("").removeData().remove(), b.opts.imageResize && ra.remove()
    ...
    function W(c) {
    	c = c || oa, c && b.events.trigger("image.beforeRemove", [c]) !== !1 && (b.popups.hideAll(), aa(!0), c.get(0) == b.$el.get(0) ? c.removeAttr("src") : ("A" == c.get(0).parentNode.tagName ? (b.selection.setBefore(c.get(0).parentNode) || b.selection.setAfter(c.get(0).parentNode), a(c.get(0).parentNode).remove()) : (b.selection.setBefore(c.get(0)) || b.selection.setAfter(c.get(0)), c.remove()), b.selection.restore(), b.html.fillEmptyBlocks()), b.undo.saveStep())
    }

    function X() {
    	if (I(), "IMG" == b.$el.get(0).tagName && b.$el.addClass("fr-view"), b.events.$on(b.$el, b.helpers.isMobile() && !b.helpers.isWindowsPhone() ? "touchend" : "click", "IMG" == b.$el.get(0).tagName ? null : 'img:not([contenteditable="false"])', _), b.helpers.isMobile() && (b.events.$on(b.$el, "touchstart", "IMG" == b.$el.get(0).tagName ? null : 'img:not([contenteditable="false"])', function() {
    		Ca = !1
    	...
    	}), b.events.on("paste.before", Z), b.events.on("paste.beforeCleanup", $), b.events.on("paste.after", Y), b.events.on("html.set", h), h(), b.events.on("html.get", function(a) {
    ...
    }), p(!0), J(!0), Q(!0), M(!0), b.events.on("node.remove", function(a) {
...
function Y() {
	b.opts.imagePaste ? b.$el.find("img[data-fr-image-pasted]").each(function(c, d) {
		if (0 === d.src.indexOf("data:")) {
			...
			"auto" != f && (f += b.opts.imageResizeWithPercent ? "%" : "px"), a(d).css("width", f), a(d).addClass("fr-dib"), oa = a(d), j(), e(), ja(), q(), b.edit.off();
			for (var g = atob(a(d).attr("src").split(",")[1]), h = [], i = 0; i < g.length; i++) h.push(g.charCodeAt(i));
				var k = new Blob([new Uint8Array(h)], {
					type: "image/jpeg"
				});
			F([k]), a(d).removeAttr("data-fr-image-pasted")
...
function ea(a) {
	oa.removeClass("fr-fir fr-fil"), "left" == a ? oa.addClass("fr-fil") : "right" == a && oa.addClass("fr-fir"), j(), e()
}
...
function ha(a) {
	oa.removeClass("fr-dii fr-dib"), "inline" == a ? oa.addClass("fr-dii") : "block" == a && oa.addClass("fr-dib"), j(), e()
}
...
var EXIF = function() {
	...
	function t(e, t) {
		...
		for (var n = atob(e), r = n.length, a = new ArrayBuffer(r), o = new Uint8Array(a), i = 0; r > i; i++) o[i] = n.charCodeAt(i);
			return a
	}
	...
	function a(e, n) {
		...
		if (e instanceof Image || e instanceof HTMLImageElement)
			if (/^data\:/i.test(e.src)) {
				...
				l.onload = function(e) { a(e.target.result) }, r(e.src, function(e) { l.readAsArrayBuffer(e) })
			} else {
				var u = new XMLHttpRequest;
				u.onload = function() {
					if ("200" != u.status) throw "Could not load image";
					a(u.response), u = null
				...
				var l = new FileReader;
				l.onload = function(e) { S && console.log("Got file of length " + e.target.result.byteLength), a(e.target.result) }, l.readAsArrayBuffer(e)
			}
		}
		...
		function o(e) {
			...
			for (var n, r = 2, a = e.byteLength; a > r;) {
				...
				if (n = t.getUint8(r + 1), S && console.log(n), 225 == n) return S && console.log("Found 0xFFE1 marker"), d(t, r + 4, t.getUint16(r + 2) - 2);
				r += 2 + t.getUint16(r + 2)
			}
		}
		...
		function s(e, t, n) {
			for (var r, a, o, i, s, l = new DataView(e), u = {}, d = t; t + n > d;) 28 === l.getUint8(d) && 2 === l.getUint8(d + 1) && (i = l.getUint8(d + 2), i in I && (o = l.getInt16(d + 3), s = o + 5, a = I[i], r = c(l, d + 5, o), u.hasOwnProperty(a) ? u[a] instanceof Array ? u[a].push(r) : u[a] = [u[a], r] : u[a] = r)), d++;
				return u
		}

		function l(e, t, n, r, a) {
			var o, i, s, l = e.getUint16(n, !a),
			c = {};
			for (s = 0; l > s; s++) o = n + 12 * s + 2, i = r[e.getUint16(o, !a)], !i && S && console.log("Unknown tag: " + e.getUint16(o, !a)), c[i] = u(e, o, t, n, a);
				return c
		}

		function u(e, t, n, r, a) {
			var o, i, s, l, u, d, g = e.getUint16(t + 2, !a),
			f = e.getUint32(t + 4, !a),
			...
			switch (g) {
				...
				for (o = f > 4 ? h : t + 8, i = [], l = 0; f > l; l++) i[l] = e.getUint8(o + l);
					return i;
				case 2:
				return o = f > 4 ? h : t + 8, c(e, o, f - 1);
				case 3:
				if (1 == f) return e.getUint16(t + 8, !a);
				for (o = f > 2 ? h : t + 8, i = [], l = 0; f > l; l++) i[l] = e.getUint16(o + 2 * l, !a);
					return i;
				case 4:
				if (1 == f) return e.getUint32(t + 8, !a);
				for (i = [], l = 0; f > l; l++) i[l] = e.getUint32(h + 4 * l, !a);
					return i;
				case 5:
				if (1 == f) return u = e.getUint32(h, !a), d = e.getUint32(h + 4, !a), s = new Number(u / d), s.numerator = u, s.denominator = d, s;
				for (i = [], l = 0; f > l; l++) u = e.getUint32(h + 8 * l, !a), d = e.getUint32(h + 4 + 8 * l, !a), i[l] = new Number(u / d), i[l].numerator = u, i[l].denominator = d;
					return i;
				case 9:
				if (1 == f) return e.getInt32(t + 8, !a);
				for (i = [], l = 0; f > l; l++) i[l] = e.getInt32(h + 4 * l, !a);
					return i;
				case 10:
				if (1 == f) return e.getInt32(h, !a) / e.getInt32(h + 4, !a);
				for (i = [], l = 0; f > l; l++) i[l] = e.getInt32(h + 8 * l, !a) / e.getInt32(h + 4 + 8 * l, !a);
					return i
			}
		}
		...
		function c(e, t, r) {
			var a = "";
			for (n = t; t + r > n; n++) a += String.fromCharCode(e.getUint8(n));
				return a
		}

		function d(e, t) {
			if ("Exif" != c(e, t, 4)) return S && console.log("Not valid EXIF data! " + c(e, t, 4)), !1;
			var n, r, a, o, i, s = t + 6;
			...
			if (8 > u) return S && console.log("Not valid TIFF data! (First offset less than 8)", e.getUint32(s + 4, !n)), !1;
			if (r = l(e, s, s + u, F, n), r.ExifIFDPointer) {
				o = l(e, s, s + r.ExifIFDPointer, P, n);
				for (a in o) {
					switch (a) {
						case "LightSource":
						case "Flash":
						...
						o[a] = D.Components[o[a][0]] + D.Components[o[a][1]] + D.Components[o[a][2]] + D.Components[o[a][3]]
					}
					r[a] = o[a]
				}
			}
			if (r.GPSInfoIFDPointer) {
				i = l(e, s, s + r.GPSInfoIFDPointer, y, n);
				for (a in i) {
					switch (a) {
						case "GPSVersionID":
						i[a] = i[a][0] + "." + i[a][1] + "." + i[a][2] + "." + i[a][3]
					}
					r[a] = i[a]
				}
			}
