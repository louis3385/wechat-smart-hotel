...
/* window.alert = function(ar) {
 ...
 ! function(a) {
 	...
 	a.extend(a.FE.POPUP_TEMPLATES, {
        ...
        imageUploadURL: "/file/upload64",//http://i.froala.com/upload",
        	...
        	if (d && "undefined" != typeof d)
        		...
        		img.onload = function() {
        			...
        			sendImg(formData, function(imgUrl) {
        				...
        				var iu=compressSrc;
        				var i = a('<img class="fr-di' + b.opts.imageDefaultDisplay[0] + ("center" != b.opts.imageDefaultAlign ? " fr-fi" + b.opts.imageDefaultAlign[0] : "") + '" src="' + imgUrl + '"' + g + (h ? ' style="max-width:100%;margin:5px auto;display:block;width: ' + h + ';"' : "") + ">");
        ...
        function E(c, d, e) {
        	...
        	h.addEventListener("load", function(ar) {
        		alert("load file");
                alert("file type is "+ar.target.result.substring(0,15));
...
function Y() {
	b.opts.imagePaste ? b.$el.find("img[data-fr-image-pasted]").each(function(c, d) {
		if (0 === d.src.indexOf("data:")) {
			...
			"auto" != f && (f += b.opts.imageResizeWithPercent ? "%" : "px"), a(d).css("width", f).css("max-width","100%"), a(d).addClass("fr-dib"), oa = a(d), j(), e(), ja(), q(), b.edit.off();
