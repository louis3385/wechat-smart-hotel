...
! function(a) { "function" == typeof define && define.amd ? define(["jquery"], a) : "object" == typeof module && module.exports ? module.exports = function(b, c) {
    ...
    b.DEFAULTS = { initOnClick: !1, pluginsEnabled: null }, b.MODULES = {}, b.PLUGINS = {}, b.VERSION = "2.2.3", b.INSTANCES = [], b.OPTS_MAPPING = {}, b.SHARED = {}, b.ID = 0, b.prototype._init = function() {
        ...
        var e;
        return { _init: d, translate: c } }, a.extend(a.FE.DEFAULTS, { placeholderText: "请最少输入10个字" }), a.FE.MODULES.placeholder = function(b) {
        ...
        return { _init: g, update: f } }, a.FE.RegisterCommand("updateText", { focus: !1, undo: !1, callback: function() { this.textEdit.update() } })
});
