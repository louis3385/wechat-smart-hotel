	...
	function resetIndex(){
        ...
        function bindButton(){
            ...
            $("#dateconfirm").unbind('click').click(function () {	
			  ...
			  $("#daywrapper ul li:eq("+Math.ceil(indexD)+")").html().substr(0,$("#daywrapper ul li:eq("+Math.round(indexD)+")").html().length-1);
              console.log(indexD);
              console.log($("#daywrapper ul li:eq("+Math.ceil(indexD)+")").html());
               if(datetime){
